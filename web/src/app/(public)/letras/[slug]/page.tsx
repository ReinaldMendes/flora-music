  ...
  return (
    <section className="section-padding bg-flora-offwhite pt-32">
      <div className="container-flora max-w-2xl">
        <AnimatedSection>
          <Link href="/letras" className="text-xs font-body text-flora-moss hover:text-flora-deep transition-colors underline-flora">
            ← Letras
          </Link>
          {track.album && (
            <Link href={`/musica/${track.album.slug}`}
              className="block mt-3 text-sm font-body text-flora-forest/55 hover:text-flora-forest transition-colors">
